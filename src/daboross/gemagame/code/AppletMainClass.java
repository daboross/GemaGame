...
public class AppletMainClass extends JApplet implements MainClass {
     ...
     *
     * @param gameOn this is a boolean that represents whether to paint the
     * RunLevel graphics or the Menu graphics. true is runLevel false is Menu
     */
    @Override
     ...
     *
     * @param g This is the graphics to paint the images onto.
     *
     ...
     *
     * @param drawNumber This is second number to use in setting the 2D array
     * @param xPos This is the x position to store
     * @param yPos This is the y position to store
     * @param xLength This is the x length to store
     * @param yLength This is the y length to store
     */
