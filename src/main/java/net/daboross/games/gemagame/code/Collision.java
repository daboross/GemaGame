...
public class Collision {
     ...
     *
     * @param xPos1 The x Position for the first object
     * @param yPos1 The y Position for the first object
     * @param xPos2 The x Position for the Second Object
     * @param yPos2 The y Position for the Second Object
     * @param xLength1 The x Length for the First Object
     * @param yLength1 The x Length for the First Object
     * @param xLength2 The x Length for the Second Object
     * @param yLength2 The x Length for the Second Object
     ...
     * @param length1 the length of the first object
     * @param p2 the position of the second object
     * @param length2 the length of the second object
