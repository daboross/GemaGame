...
public class LevelLoader {
    ...
    public boolean load(List<String> lineList) {
        if (lineList == null) {
            return false;
        }
        List<Integer> platformsToAddXPos = new ArrayList<Integer>();
        List<Integer> platformsToAddYPos = new ArrayList<Integer>();
        List<Integer> platformsToAddXLength = new ArrayList<Integer>();
        List<Integer> platformsToAddYLength = new ArrayList<Integer>();
            ...
            while (nextNumberEquals < 4) {
                if (charNumber < lineLength) {
                    ...
                    if (java.lang.Character.isDigit(currentChar)
                        ...
                        charNumber++;
                    } else if (!"".equals(currentSequence)) {
    ...
    public PlatformList loadToList(List<String> lineList) {
        List<Integer> platformsToAddXPos = new ArrayList<Integer>();
        List<Integer> platformsToAddYPos = new ArrayList<Integer>();
        List<Integer> platformsToAddXLength = new ArrayList<Integer>();
        List<Integer> platformsToAddYLength = new ArrayList<Integer>();
