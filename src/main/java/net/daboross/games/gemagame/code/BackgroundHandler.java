...
public class BackgroundHandler implements Paintable {
     ...
     *
     * @param backgroundNumber The number of the Background to get. Only use 0
     * or 1.
     * @param layerNumber The layer number of the Background to get. Will return
     * 0 if invalid number is specified
