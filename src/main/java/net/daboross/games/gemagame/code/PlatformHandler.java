...
public class PlatformHandler {
     ...
     * platform 6.
     */
    private List<Integer> xPosList, yPosList, xLengthList, yLengthList;
    /**
     ...
     *
     * @param xPos this is the x position of the platform you are adding
     * @param yPos this is the y position of the platform you are adding
     * @param xLength this is the x length of the platform you are adding
     * @param yLength this is the y length of the platform you are adding
     */
