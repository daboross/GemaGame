...
public class ObjectHandler {
    ...
    /**
     * @param backgroundHandler the backgroundHandler to set
     */
    ...
    /**
     * @param jApplet the jApplet to set
     */
    ...
    /**
     * @param levelCreator the levelCreator to set
     */
    ...
    /**
     * @param levelLoader the levelLoader to set
     */
    ...
    /**
     * @param loadingScreen the loadingScreen to set
     */
    ...
    /**
     * @param runLevelThread the runLevelThread to set
     */
    ...
    /**
     * @param levelFileWriterThread the levelFileWriterThread to set
     */
    ...
    /**
     * @param menuThread the menuThread to set
     */
    ...
    /**
     * @param loadingScreenThread the loadingScreenThread to set
     */
    ...
    /**
     * @param levelCreatorThread the levelCreatorThread to set
     */
    ...
    /**
     * @param overlayHandler the overlayHandler to set
     */
    ...
    /**
     * @param platformHandler the platformHandler to set
     */
