...
public class Projectile {
     ...
     *
     * @param comX This is the starting x Position relative to the scrolling
     * 0,0. Should include the current background scroll
     * @param comY The starting Y position of this projectile
     * @param speedX this is the X speed of this projectile for its entire life
     * @param speedY this is the Y speed of this projectile for its entire life
     * @param rightEdge this is the width of the game
     * @param bottomEdge this is the height of the game
     */
